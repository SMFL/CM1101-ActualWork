...
def normalise_input(user_input):
    ...
    Next_Word_Start_Point = 0;
    for char in range(0, len(no_punct)):
        if(no_punct[char] == " "):
            Words.append(no_punct[Next_Word_Start_Point:char])
            Next_Word_Start_Point = char + 1
        elif(char == len(no_punct) - 1):
            Words.append(no_punct[Next_Word_Start_Point:char+ 1])
